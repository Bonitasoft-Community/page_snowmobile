...
public class JdbcTable {
    ...
    public String getContentFromConnection(final Connection con, final OperationStatus operationStatus)
    {
        ...
        try {
            ...
            rs = databaseMetaData.getColumns(null /* catalog */, null /* schema */, sqlOriginaltableName, null /* columnNamePattern */);
            while (rs.next())
            {
            ...
            rs = databaseMetaData
                    .getIndexInfo(null /* String catalog */, null /* String schema */, sqlOriginaltableName, false /* unique */, false /* boolean approximate */);
            while (rs.next())
            {
