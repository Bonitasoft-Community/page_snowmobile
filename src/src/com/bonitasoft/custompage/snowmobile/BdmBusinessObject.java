...
public class BdmBusinessObject {
  ...
  public void readFromXml(final Node oneBusinessObjectNode, final OperationStatus operationStatus) {
    name = JdbcTable.getFormatTableName( XmlToolbox.getXmlAttribute(oneBusinessObjectNode, "qualifiedName"));
    ...
    while (fieldNode != null) {
      ...
      if (fieldNode.getNodeName().equals("relationField")) {
        ...
        try {
          ...
          operationStatus.addErrorMsg("Illegal relation BusinessObject[" + getName() + "] field[" + field.getName() + "] type get["
